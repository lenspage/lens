...
import style from "@/styles/svg.module.scss";

export default function Logo({ code = true }) {
	if (code) {
		return (
			<div className="mt-[3px] ml-[3px] w-14">
				<svg
					version="1.1"
					id="wordmark"
					...
					x="0px"
					y="0px"
					viewBox="0 0 1325.09 262.37"
					style={{ enableBackground: "new 0 0 1325.09 262.37" }}
					xmlSpace="preserve"
				>
					<g className={style.svg}>
						<path d="M292.71,256.23H0V6.14h97.51v170.82h195.2V256.23z" />
						<path d="M605.29,256.23h-292.7V6.14H605.3v64.01H410.1v32.01h195.2v57.87H410.1v32.01h195.2v64.19H605.29z" />
						<path d="M966.82,256.23H857.03L722.68,103.46v152.77h-97.51V6.14h134.16l109.79,132.49V6.14h97.69v250.09H966.82z" />
						<path
							d="M1087.84,88.57c0,3.6,3.07,6.33,9.21,8.19s14.45,3.2,24.93,4c10.48,0.81,22.3,1.52,35.45,2.14
